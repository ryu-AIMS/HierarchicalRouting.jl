...
function load_problem(target_scenario::String="")::Problem
    ...
    ms_exclusions::DataFrame = ms_exclusion_zones_df |> simplify_exclusions! |>
        buffer_exclusions! |> unionize_overlaps! |> simplify_exclusions!
    ...
    t_exclusions = simplify_exclusions!(t_exclusions, min_area=1E-8, simplify_tol=5E-5)
